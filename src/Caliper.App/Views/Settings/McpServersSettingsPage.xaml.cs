...
{
    public McpServersSettingsViewModel ViewModel { get; } =
        App.Services.GetRequiredService<McpServersSettingsViewModel>();

    private readonly ILogger<McpServersSettingsPage> _logger =
        App.Services.GetRequiredService<ILogger<McpServersSettingsPage>>();

    public McpServersSettingsPage() => InitializeComponent();
