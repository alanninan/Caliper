...
public sealed partial class AgentBehaviorSettingsPage : Page
{
    public AgentBehaviorSettingsViewModel ViewModel { get; } =
        App.Services.GetRequiredService<AgentBehaviorSettingsViewModel>();

    private readonly ILogger<AgentBehaviorSettingsPage> _logger =
        App.Services.GetRequiredService<ILogger<AgentBehaviorSettingsPage>>();

    public AgentBehaviorSettingsPage() => InitializeComponent();
